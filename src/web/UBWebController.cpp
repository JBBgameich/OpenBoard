...
QPixmap UBWebController::getScreenPixmap()
{
    ...
    QScreen *primaryScreen = QGuiApplication::screenAt(QCursor::pos());
    const QRect primaryScreenRect = primaryScreen->geometry();
    QCoreApplication::processEvents();

    return primaryScreen->grabWindow(qApp->desktop()->winId(),
